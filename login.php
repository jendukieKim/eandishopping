	...
	if($_POST){
		if(empty($_POST['email']) || empty($_POST['password'])){
			...
			if(empty($_POST['password'])){
				...
				$passwordError = 'Password at least 5 characters';
			}
		}else{
			$email = $_POST['email'];
			...
			if($result){
				...
				echo "<script>alert('Register first');window.location.href='login.php';</script>";
					...
					<div class="login_form_inner">
						...
						<form class="row login_form" action="login.php" method="post" id="contactForm" novalidate="novalidate">
							...
							<div class="col-md-12 form-group">
								...
								<input type="password"  class="form-control" id="password" name="password" style="<?php echo empty($passwordError
